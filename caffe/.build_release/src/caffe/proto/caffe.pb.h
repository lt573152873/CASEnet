...
enum ImageDataParameter_LabelType {
  ...
  ImageDataParameter_LabelType_PIXELML = 3
};
...
const ImageDataParameter_LabelType ImageDataParameter_LabelType_LabelType_MAX = ImageDataParameter_LabelType_PIXELML;
...
class ImageDataParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LabelType PIXELML = ImageDataParameter_LabelType_PIXELML;
  ...
  // optional uint32 num_label_chn = 17 [default = 1];
  inline bool has_num_label_chn() const;
  inline void clear_num_label_chn();
  static const int kNumLabelChnFieldNumber = 17;
  inline ::google::protobuf::uint32 num_label_chn() const;
  inline void set_num_label_chn(::google::protobuf::uint32 value);

  // optional uint32 num_edge_chn = 18 [default = 0];
  inline bool has_num_edge_chn() const;
  inline void clear_num_edge_chn();
  static const int kNumEdgeChnFieldNumber = 18;
  inline ::google::protobuf::uint32 num_edge_chn() const;
  inline void set_num_edge_chn(::google::protobuf::uint32 value);

  // optional string edge_file_prefix_format = 19;
  inline bool has_edge_file_prefix_format() const;
  inline void clear_edge_file_prefix_format();
  static const int kEdgeFilePrefixFormatFieldNumber = 19;
  inline const ::std::string& edge_file_prefix_format() const;
  inline void set_edge_file_prefix_format(const ::std::string& value);
  inline void set_edge_file_prefix_format(const char* value);
  inline void set_edge_file_prefix_format(const char* value, size_t size);
  inline ::std::string* mutable_edge_file_prefix_format();
  inline ::std::string* release_edge_file_prefix_format();
  inline void set_allocated_edge_file_prefix_format(::std::string* edge_file_prefix_format);
 ...
 private:
  ...
  inline void set_has_num_label_chn();
  inline void clear_has_num_label_chn();
  inline void set_has_num_edge_chn();
  inline void clear_has_num_edge_chn();
  inline void set_has_edge_file_prefix_format();
  inline void clear_has_edge_file_prefix_format();
  inline void set_has_scale();
  inline void clear_has_scale();
  inline void set_has_mean_file();
  inline void clear_has_mean_file();
  ...
  bool is_color_;
  bool mirror_;
  ::google::protobuf::uint32 num_label_chn_;
  ::std::string* edge_file_prefix_format_;
  ::google::protobuf::uint32 num_edge_chn_;
  float scale_;
  ::std::string* mean_file_;
...
// optional uint32 num_label_chn = 17 [default = 1];
inline bool ImageDataParameter::has_num_label_chn() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ImageDataParameter::set_has_num_label_chn() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ImageDataParameter::clear_has_num_label_chn() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ImageDataParameter::clear_num_label_chn() {
  num_label_chn_ = 1u;
  clear_has_num_label_chn();
}
inline ::google::protobuf::uint32 ImageDataParameter::num_label_chn() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.num_label_chn)
  return num_label_chn_;
}
inline void ImageDataParameter::set_num_label_chn(::google::protobuf::uint32 value) {
  set_has_num_label_chn();
  num_label_chn_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.num_label_chn)
}

// optional uint32 num_edge_chn = 18 [default = 0];
inline bool ImageDataParameter::has_num_edge_chn() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ImageDataParameter::set_has_num_edge_chn() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ImageDataParameter::clear_has_num_edge_chn() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ImageDataParameter::clear_num_edge_chn() {
  num_edge_chn_ = 0u;
  clear_has_num_edge_chn();
}
inline ::google::protobuf::uint32 ImageDataParameter::num_edge_chn() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.num_edge_chn)
  return num_edge_chn_;
}
inline void ImageDataParameter::set_num_edge_chn(::google::protobuf::uint32 value) {
  set_has_num_edge_chn();
  num_edge_chn_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.num_edge_chn)
}

// optional string edge_file_prefix_format = 19;
inline bool ImageDataParameter::has_edge_file_prefix_format() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void ImageDataParameter::set_has_edge_file_prefix_format() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ImageDataParameter::clear_has_edge_file_prefix_format() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ImageDataParameter::clear_edge_file_prefix_format() {
  if (edge_file_prefix_format_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    edge_file_prefix_format_->clear();
  }
  clear_has_edge_file_prefix_format();
}
inline const ::std::string& ImageDataParameter::edge_file_prefix_format() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.edge_file_prefix_format)
  return *edge_file_prefix_format_;
}
inline void ImageDataParameter::set_edge_file_prefix_format(const ::std::string& value) {
  set_has_edge_file_prefix_format();
  if (edge_file_prefix_format_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    edge_file_prefix_format_ = new ::std::string;
  }
  edge_file_prefix_format_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.edge_file_prefix_format)
}
inline void ImageDataParameter::set_edge_file_prefix_format(const char* value) {
  set_has_edge_file_prefix_format();
  if (edge_file_prefix_format_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    edge_file_prefix_format_ = new ::std::string;
  }
  edge_file_prefix_format_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ImageDataParameter.edge_file_prefix_format)
}
inline void ImageDataParameter::set_edge_file_prefix_format(const char* value, size_t size) {
  set_has_edge_file_prefix_format();
  if (edge_file_prefix_format_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    edge_file_prefix_format_ = new ::std::string;
  }
  edge_file_prefix_format_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ImageDataParameter.edge_file_prefix_format)
}
inline ::std::string* ImageDataParameter::mutable_edge_file_prefix_format() {
  set_has_edge_file_prefix_format();
  if (edge_file_prefix_format_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    edge_file_prefix_format_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ImageDataParameter.edge_file_prefix_format)
  return edge_file_prefix_format_;
}
inline ::std::string* ImageDataParameter::release_edge_file_prefix_format() {
  clear_has_edge_file_prefix_format();
  if (edge_file_prefix_format_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = edge_file_prefix_format_;
    edge_file_prefix_format_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ImageDataParameter::set_allocated_edge_file_prefix_format(::std::string* edge_file_prefix_format) {
  if (edge_file_prefix_format_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete edge_file_prefix_format_;
  }
  if (edge_file_prefix_format) {
    set_has_edge_file_prefix_format();
    edge_file_prefix_format_ = edge_file_prefix_format;
  } else {
    clear_has_edge_file_prefix_format();
    edge_file_prefix_format_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.ImageDataParameter.edge_file_prefix_format)
}
